...
def vgg16_conv1_batch_size_experiment():
    
    exp = Experiment("vgg16_conv1_batch")
...
def vgg16_conv2_batch_size_experiment():
    
    exp = Experiment("vgg16_conv2_batch")
...
def vgg16_conv3_batch_size_experiment():
    
    exp = Experiment("vgg16_conv3_batch")
...
def vgg16_conv4_batch_size_experiment():
    
    exp = Experiment("vgg16_conv4_batch")
...
def vgg16_conv5_batch_size_experiment():
    
    exp = Experiment("vgg16_conv5_batch")
...
def vgg16_fc_batch_size_experiment():
    
    exp = Experiment("vgg16_fc_batch")
    exp.params['n'] = [1, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096]
    exp.params['c'] = [4096]
    exp.params['h'] = [1]
    exp.params['w'] = [1]
